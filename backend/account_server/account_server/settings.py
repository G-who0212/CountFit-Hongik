"""
Django settings for account_server project.
...
SECRET_KEY = 'django-insecure-2i-sh)y0k7^5bv)63)*kb&10p(@d1cqrnvk1me7p*ptv*y93t!'
...
ROOT_URLCONF = 'account_server.urls'
...
WSGI_APPLICATION = 'account_server.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'cicd-countfit-db.czwnvzkepohe.ap-northeast-2.rds.amazonaws.com',
        'PORT': '3306',
    }
}
